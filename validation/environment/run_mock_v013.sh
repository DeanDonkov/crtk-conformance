#!/bin/bash
# v0.1.3 mock validation campaign inside focal-crtk:rc3 (mount /home/claude/rc3 at /rc3)
...
python3 validation/run_validation_v013.py --out validation/v0.1.3/mock "$@" 2>&1 | tee validation/v0.1.3/mock/run_validation_v013.log
