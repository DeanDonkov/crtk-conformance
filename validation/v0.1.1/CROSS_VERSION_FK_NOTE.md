...
|---|---|---|---|---|
| v1.0.0 (158b554e) | 1.0 | 0.96728 | 0.967 | 0.96729 |
...
ratio is exactly 10 (0.967 vs 0.0967). The v1.0.0 live value differs from its nominal FK (0.96728 vs 0.967)
because the gravity-loaded v1.0.0 arm settled at measured_js = (0.013, -0.037, 1.0003, 0.0001, 0.0082, -0.0075)
rather than at the commanded configuration; FK of that vector is 0.96729.
...
and the constants differ by a factor of ten (the D2 claim, ledger P01/P02/P62/P63, D17). It does not measure the
